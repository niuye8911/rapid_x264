...
extern  int  rapids_rate_control; /* dynamic change of quantization within 1..50 range */
extern  int  rapids_qp_steps;    /* granularity of possible qp change */
extern  int  rapids_frame_cnt;     /* counter for current processed frame */
...
/* ULI - object with parameters for encoding */
typedef struct x264_param_t
{
    ...
    int         i_frame_reference;  /* Maximum number of reference frames */ /* ULI */
